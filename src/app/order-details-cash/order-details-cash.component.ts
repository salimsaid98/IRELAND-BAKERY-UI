...
======================= */
@Component({
  selector: 'app-order-details-cash',
  templateUrl: './order-details-cash.component.html',
  styleUrls: ['./order-details-cash.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class OrderDetailsCashComponent  implements OnInit {
  ...
  loadOrderData() {
    ...
    this.orderItemsService.getOrderItemsByApp_user_and_date(id, this.order_date)
